								...
								<div class="contact-wrap w-100 p-md-5 p-4">
									...
									<form method="POST" id="contactForm" name="contactForm">
										<div class="dropdown">
											...
											<div class="dropdown-menu"
												...
												<c:forEach items="${typereclamation}" var="re">
													<a
														href="/ProjetServletJsp/AddReclamation?x=${re.getType()}" >${re.getType()}</a>
										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group">
													<input type="submit" name="action" value="Ajout Reclamation"
														class="btn btn-primary" />
														<input type="submit" name="action" value="Voir Reclamation"
														class="btn btn-primary" />
