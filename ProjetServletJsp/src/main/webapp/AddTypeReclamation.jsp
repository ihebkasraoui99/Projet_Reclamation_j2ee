...
<body>
	...
	<a href="/ProjetServletJsp/Login" class="btn btn-primary" >Deconnexion</a>
		<div class="container">
						...
						<div class="row no-gutters">
							<div class="col-md-7 d-flex align-items-stretch">
								<div class="contact-wrap w-100 p-md-5 p-4">
									<h3 class="mb-4">Ajouter un Type de Reclamation</h3>
							...
							<div class="btn-group">
										...
										<div class="row">
											<div class="col-md-6">
													...
													<input  type ="text"  name="type" id="titre" placeholder="Titre">
											...
											<div class="col-md-12">
												<div class="form-group">
													<input type="submit" name="action" value="Ajout Type"class="btn btn-primary"/>
